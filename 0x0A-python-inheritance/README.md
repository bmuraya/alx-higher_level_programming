...
Inheritance is a fundamental concept in object-oriented programming (OOP) that allows you to create a new class (called a "derived" or "subclass") based on an existing class (called a "base" or "superclass").
